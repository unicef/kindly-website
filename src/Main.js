    ...
    <main>
      ...
      >
        ...
        <footer className="cover-footer mt-auto">
          <HashLink
            to="#about"
            className={"text-decoration-none " + colors["title"]}
          >
          ...
          <div className="row align-items-center g-5 py-5">
            ...
            <div className="col-lg-3 offset-lg-2">
              <p className="lead text-lg-start text-center">
                Kindly is the product of a collaboration between UNICEF and
          ...
          <div className="row align-items-center g-5 py-5 flex-row-reverse">
            ...
            <div className="col-lg-5 offset-1">
              ...
              <p style={{ fontSize: "1.2em" }}>
                Kindly evaluates messages before they are sent and offers users
                the chance to modify them.
              </p>
              <p style={{ fontSize: "1.2em" }}>
                Kindly aims to make children feel safer by leveraging the latest
                advances in technology and by empowering children to solve this
                pressing challenge.
              </p>
            </div>
          </div>
        ...
        <div className="container-lg">
          <div className="row align-items-center g-5 py-5 mb-5">
            <div className="col-lg-5 offset-lg-1 text-lg-start text-center px-5">
              ...
              <p>
                Reply to the message and check your entry with Kindly to see if
                your message is toxic or considered cyberbullying.
              </p>
            </div>
            <div className="col-lg-5 offset-lg-1">
              <KindlyForm />
        ...
        <div className="container-lg">
          <div className="row align-items-center pt-5 pb-3">
            <div className="col-lg-7 text-center mx-auto">
              ...
              <p className="text-grey">
                When integrated with existing text-based platforms, Kindly
                allows users to check and edit their messages for toxic intent.
              </p>
            </div>
          </div>
          <div className="row px-lg-5 pb-5 align-items-start">
            <div className="col-lg-3 text-center mx-auto px-5 mt-4 mt-md-0">
              ...
              <p>
                Users prompt Kindly to evaluate their message draft for toxic
                text or cyberbullying intent
              </p>
            </div>
            <div className="col-lg-3 text-center mx-auto mt-4 mt-md-0">
              ...
              <p>
                Feedback on the message offers users the chance to edit their
                original message
              </p>
            </div>
            <div className="col-lg-3 text-center mx-auto px-5 mt-4 mt-md-0">
              ...
              <p>
                Users choose to send the final message after seeing and/or
        ...
        <div className="container-lg">
          <div className="row align-items-center g-5 py-5">
            <div className="col-lg-7 text-center mx-auto text-white text-center">
              <h2>
                One-third of the globe’s youth is bullied. It affects everyone:
                those who are bullied, those who bully others, and those who
                witness bullying. And it doesn’t stop in the physical world. It
                happens online, too.
              </h2>
            </div>
          </div>
      ...
      <div className="container-lg p-5" id="why-kindly">
        <div className="row align-items-center g-5 py-5">
          <div className="col-lg-7 text-center mx-auto">
            ...
            <p className="text-grey">
              Partners Gitanjali Rao and UNICEF provide the principles that make
              Kindly an excellent digital tool that empowers children.
            </p>
          </div>
        </div>
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-5 mx-auto">
            ...
            <p>
              To take full account of children’s issues and rights online,
              UNICEF has developed a{" "}
              <a
              ...
              for data governance to protect children’s data and their rights
              and prioritize children’s best interests. Thus, UNICEF is uniquely
              positioned to provide strong child data protection guarantees and
              offer a trusted digital public good that puts children first.
            </p>
          </div>
        </div>
        ...
        <div className="row align-items-center px-md-5 flex-row-reverse mt-4">
          ...
          <div className="col-lg-5 mx-auto">
            ...
            <p>
              By developing Kindly as an open-source solution, UNICEF encourages
              and empowers children to be part of the solution to a challenge
              that many of them face directly. Kindly provides systems of
              iterative improvement that allow the tool to meet the specific
        ...
        <div className="row align-items-center px-md-5 mt-4">
          ...
          <div className="col-lg-5 mx-auto mt-3">
            ...
            <p>
              While similar services to Kindly exist in the market, they do not
              ...
              messages, and centers their own safety and protections in the
              solution.
            </p>
          </div>
        </div>
          ...
          <div className="col-lg-7 mx-auto">
            ...
            <Accordion className="pb-3 pt-4">
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                  Kindly offers a public API that any online service provider
                  can leverage to integrate with their existing product
                  offering. It is as simple as sending any message that the user
                  is typing to that API endpoint, and process the response to
                  provide feedback to the user on whether that user-generated
                  content is fine to post, or the user should reconsider their
                  language before posting. Contact{" "}
                  <a href="mailto:kindly@unicef.org" rel="noreferrer">
                    kindly@unicef.org
                  </a>{" "}
                  with any technical questions around the integration
                  possibilities.
                </Accordion.Body>
              </Accordion.Item>
            </Accordion>
            ...
            <Accordion className="pb-3">
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                  Kindly was created for children between the ages of 10 and 18
                  years in an effort to end cyberbullying and make them feel
                  safer. Kindly can be integrated with any platform that
                  provides text-based services (such as chat interface, email
                  platform, etc.) to benefit children, globally. While the
                  current version is available in English, more languages are
            ...
            <Accordion className="pb-3">
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                  ...
                  standards that promote the protection and safeguarding of all
                  children. It is also supported by UNICEF’s{" "}
                  <a
                  ...
                  standards that ensure that individuals' privacy rights are
                  honored and their data appropriately protected. However, if
                  someone wishes to contribute to the training data set, they
                  can do so through our <i>Contribute Page</i>. Before being
                  added to the training open data set, the data will be
                  anonymized and reviewed by trusted UNICEF staff to maintain
            ...
            <Accordion className="pb-3">
              <Accordion.Item eventKey="0">
                <Accordion.Header>
                  How can I get involved with Kindly?
                </Accordion.Header>
                <Accordion.Body>
                  We’d love to have you! To keep up with Kindly’s progress and
                  latest developments, access the{" "}
                  <a
        ...
        <div className="container-lg">
          ...
          <div className="row align-items-center g-5 py-5">
            <div className="col-lg-4 mx-auto text-center">
              ...
              <p>
                Keep up with Kindly’s progress by accessing the UNICEF/Kindly
                software repository
              </p>
              <Button
            ...
            <div className="col-lg-4 mx-auto text-center pt-5 pt-lg-0">
              ...
              <p>
                Connect with Kindly to learn more about Kindly or to explore a
